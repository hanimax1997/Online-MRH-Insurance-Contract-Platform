...
export class MrhComponent implements AfterViewInit {
  ...
  steps = [
    { label: 'Assuré', icon: 'assets/images/icon1.png' },
    { label: 'Risque', icon: 'assets/images/icon2.png' },
    { label: 'Récapitulatif', icon: 'assets/images/icon3.png' }
  ];
  ...
  *  UTILITAIRES (extraits)                                                 */
  ...
  async submitDevis(): Promise<void> {
    ...
    try {
      ...
      this.devisService.mailDevis(this.idDevis, rawToken)
      .subscribe({
